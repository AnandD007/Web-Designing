...
const AddCustomerPage = () => {
    ...
    const handleSubmit = (e:any) => 
    {
        ...
        const validLandmark = new RegExp('^[a-zA-Z]+([a-zA-Z]+)*$');
        const validStreetName = new RegExp('^[a-zA-Z]+([a-zA-Z]+)*$');
        ...
        else if (!validStreetName.test(custStreetName) && custStreetName!='') 
        {
            alert("Please Enter a valid Street Name");
        }
        else if (!validLandmark.test(custLandmark) && custLandmark!='') 
        {
